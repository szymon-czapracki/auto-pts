...
def hdl_wid_17(desc):
    ...
    for attr in attrs:
        ...
        (_, uuid_len, uuid) = btp.gatts_get_attr_val(btp.pts_addr_type_get(None),
                                                     btp.pts_addr_get(None), handle)
...
def hdl_wid_22(desc):
    ...
    for attr in attrs:
        ...
        val = btp.gatts_get_attr_val(btp.pts_addr_type_get(None),
                                         btp.pts_addr_get(None), start_handle)
        if not val:
            continue
...
def hdl_wid_25(desc):
    ...
    for svc in svcs:
        ...
        svc_val = btp.gatts_get_attr_val(btp.pts_addr_type_get(None),
                                         btp.pts_addr_get(None), handle)
        if not svc_val:
            continue
...
def hdl_wid_52(desc):
    ...
    _, _, value = btp.gatts_get_attr_val(btp.pts_addr_type_get(None), btp.pts_addr_get(None), handle)
...
def hdl_wid_56(desc):
    ...
    att_rsp, value_len, value = btp.gatts_get_attr_val(btp.pts_addr_type_get(None),
                                                btp.pts_addr_get(None), handle1)
    values_read += hexlify(value)

    att_rsp, value_len, value = btp.gatts_get_attr_val(btp.pts_addr_type_get(None),
                                                btp.pts_addr_get(None), handle2)
    values_read += hexlify(value)
...
def hdl_wid_75(desc):
    ...
    attr = btp.gatts_get_attr_val(btp.pts_addr_type_get(None),
                                    btp.pts_addr_get(None), handle)
...
def hdl_wid_110(desc):
    ...
    for chrc in chrcs:
        ...
        chrc_val = btp.gatts_get_attr_val(btp.pts_addr_type_get(None),
                                            btp.pts_addr_get(None), handle)
        if not chrc_val:
            continue
...
def hdl_wid_112(desc):
    ...
    for chrc in chrcs:
        ...
        handle, perm, type_uuid = chrc_value_attr[0]
        chrc_value_data = btp.gatts_get_attr_val(btp.pts_addr_type_get(None),
                                                btp.pts_addr_get(None), handle)
...
def hdl_wid_113(desc):
    ...
    for chrc in chrcs:
        ...
        chrc_data = btp.gatts_get_attr_val(btp.pts_addr_type_get(None),
                                            btp.pts_addr_get(None), handle)
        if not chrc_data:
            continue
